...
# Changed to split data into train and validation sets
  ...
  with futures.ThreadPoolExecutor(
    ...
    all_futures = [
        executor.submit(download_one_image, bucket, split, image_id,
                        "data/images/validation" if i % 10 == 0 else "data/images/train") for i, (split, image_id) in enumerate(image_list)
    ]
...
# Changed to not allow command line argument for download folder, but rather just create train and validation folders
